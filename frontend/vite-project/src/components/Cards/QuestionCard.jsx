...
const QuestionCard = ({
  ...
  return <>
  <div className='ml-10 bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 group'>
    <div className='flex items-start justify-between cursor-pointer'>
        <div className='flex items-center gap-3.5'>
            ...
            <h3 
                className='text-ms md:text-[14px] font-medium text-gray-800 mr-0 md:mr-20'
        ...
        <div className='flex items-center justify-end ml-4 relative'>
            ...
            >
                ...
                onClick={onTogglePinStatus}
            >
                {isPinned ? (
                    <LuPinOff className='tex-xs' />
                ) : (
